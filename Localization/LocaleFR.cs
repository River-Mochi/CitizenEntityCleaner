    ...
    public class LocaleFR : IDictionarySource
    {
            ...
            IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionTabLocaleID(Setting.DebugTab), "Débogage" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.LogDiagnosticReportButton)), "Écrire le rapport de diagnostic" },
